...
import {
  COST_PER_UNIT,
  TEXT_MAX_LENGTH,
} from "@/features/dashboard/components/text-input-panel";
...
export function TextInputPanel() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col flex-1 px-4 py-4">
      ...
      {text.length > 0 ? (
        ...
        <div className="hidden items-center justify-end lg:flex">
          <p className="text-xs tracking-tight text-muted-foreground">
            {TEXT_MAX_LENGTH.toLocaleString()} characters max
          </p>
        </div>
      )}
    </div>
